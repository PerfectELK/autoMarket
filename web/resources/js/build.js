...
/***/ (function(module, exports, __webpack_require__) {
	...
	const DatePicker = __webpack_require__(31);
	...
	if(dataPage == 'main') {
	    ...
	    const carItem = __webpack_require__(38);
	    ...
	    const carItem = __webpack_require__(43);
	    const addClient = __webpack_require__(48);
	    const addCar = __webpack_require__(63);
	    const carModal = __webpack_require__(71);
	    const rentModal = __webpack_require__(76);
	    const rentTable = __webpack_require__(81);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\vendor\\date.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        createDayArray: function createDayArray() {
	            var j = [];
	        ...
	        closeTimeWindow: function closeTimeWindow(e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\client\\carItem.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-6c9af3db/carItem.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./carItem.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./carItem.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        loadCapOrnumberOfSeats: function loadCapOrnumberOfSeats() {
	            if (this.description.item.load_capacity != void 0 && this.description.item.load_capacity != 0) {

	                this.loadCapOrNum[0] = 'Грузоподъемность';
	                this.loadCapOrNum[1] = this.description.item.load_capacity;
	            } else {
	                this.loadCapOrNum[0] = 'Количество мест';
	                this.loadCapOrNum[1] = this.description.item.number_of_seats;
	            }
	        }
	    },
	    created: function created() {
...
/***/ (function(module, exports) {
	...
	module.exports = "\n<div class=\"col-md-3 car__item\">\n    <div class=\"card mb-4 shadow-sm\">\n\n        <img v-bind:src=\"description.item.img\" alt=\"\" class=\"car__item-img w-100\">\n\n        <div class=\"card-body w-100\">\n            <p class=\"card-text\">Модель:  <b>{{description.item.title}}</b></p>\n            <p class=\"card-text\">Тип :  <b>{{this.type[description.item.type]}}</b></p>\n            <p class=\"card-text\">Топливо : {{description.item.fuel }}</p>\n            <p class=\"card-text\">Цена : {{description.item.price }}</p>\n            <p class=\"card-text\">{{this.loadCapOrNum[0]}} : {{this.loadCapOrNum[1]}}</p>\n            <div class=\"d-flex justify-content-between align-items-center\">\n                <div class=\"btn-group\">\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\carItem.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-a25a8c7a/carItem.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\addClient.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-64092d08/addClient.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addClient.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addClient.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var masterCar = __webpack_require__(52);
	var tenant = __webpack_require__(57);
	module.exports = {
	    components: {
	        masterCar: masterCar,
	        tenant: tenant
	    ...
	    methods: {
	        changeType: function changeType() {
	            var type = parseInt(this.currentType);
	            if (type) {
	                this.master = false;
	                this.tenant = true;
	            } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\forms\\addMasterOfCar.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-c21b65ca/addMasterOfCar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addMasterOfCar.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addMasterOfCar.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	    ...
	    methods: {
	        add: function add() {
	            ...
	            if (this.fio.trim() != "" && this.passport.trim() != "" && this.driverNum.trim() && this.phone.trim() != "") {
	                ...
	                var param = $.param({ data: { c: 'CarController', m: 'addMaster', params: data } });
	                axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                    if (response.data) {
	                        _this.getMessage("Клиент успешно добавлен");
	                        _this.clearFields();
	                    } else {
	                        _this.getMessage("Произошла ошибка, избейте разработчика");
	                    }
	                }).catch(function (e) {});
	            } else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\forms\\addTenant.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-b817db0c/addTenant.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addTenant.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addTenant.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	    ...
	    methods: {
	        add: function add() {
	            ...
	            if (this.fio.trim() != "" && this.passport.trim() != "" && this.driverNum.trim() && this.phone.trim() != "") {
	                ...
	                var param = $.param({ data: { c: 'CarController', m: 'addTenant', params: data } });
	                axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                    if (response.data) {
	                        _this.getMessage("Клиент успешно добавлен");
	                        _this.clearFields();
...
/***/ (function(module, exports) {
	...
	module.exports = "\n<div class=\"w-100 modal__body\">\n    <p class=\"alert alert-danger display-none w-100 mt-2\">{{ alert }}</p>\n\n    <label for=\"FIO\">ФИО</label>\n    <input type=\"text\" id=\"FIO\" class=\"form-control\" v-model=\"fio\">\n\n    <label for=\"Passport\">Паспорт</label>\n    <input type=\"text\" id=\"Passport\" class=\"form-control\" v-model=\"passport\">\n\n    <label for=\"DPnum\">Номер ВУ</label>\n    <input type=\"text\" id=\"DPnum\" class=\"form-control\" v-model=\"driverNum\">\n\n    <label for=\"phone\">Телефон</label>\n    <input type=\"tel\" class=\"form-control\" id=\"phone\" v-model=\"phone\">\n\n    <button class=\"btn btn-primary mt-5\" v-on:click=\"this.add\">Добавить арендатора</button>\n</div>\n";

/***/ }),
/* 62 */
/***/ (function(module, exports) {

	module.exports = "\n<div class=\"w-100 modal__body\">\n<label for=\"type\">Тип:</label>\n<select name=\"\" id=\"type\" class=\"form-control\" v-model=\"currentType\" v-on:change=\"this.changeType\">\n    <option value=\"0\">Владелец</option>\n    <option value=\"1\">Арендатор</option>\n</select>\n    <master-car v-if=\"this.master\"></master-car>\n    <tenant v-if=\"this.tenant\"></tenant>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\addCar.vue: named exports in *.vue files are ignored.")}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addCar.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./addCar.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        inputPicture: function inputPicture(event) {
	            this.picture = event.target.files[0];
	        },
	        getMasters: function getMasters() {
	            var _this = this;

	            var param = $.param({ data: { c: 'CarController', m: 'getMasters' } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                _this.masters = response.data;
	            });
	        },
	        addCar: function addCar() {
	            var _this2 = this;

	            if (this.name.trim() != "" && this.price.trim() != "" && this.fuel.trim() != "" && this.depOnChoose.trim() != "" && this.master != "" && this.price.trim() != "" && this.picture != void 0) {
	                var fd = new FormData();
	                var obj = {
	                    name: this.name,
	                    fuel: this.fuel,
	                ...
	                fd.append('formDataJson', (0, _stringify2.default)(obj));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\forms\\carModal.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-1553adba/carModal.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./carModal.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./carModal.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getMaster: function getMaster() {
	            ...
	            var param = $.param({ data: { c: 'CarController', m: 'getMaster', id: this.description.master } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                var m = response.data[0];
	                _this.master.id = m.id;
	                _this.master.name = m.name;
	                _this.master.driverNum = m.driverNum;
	                _this.master.passport = m.passport;
	                _this.master.phone = m.phone;
	            });
	        },
	        reSaveMaster: function reSaveMaster() {
	            var _this2 = this;
	            ...
	            var param = $.param({ data: { c: 'CarController', m: 'updateCustomer', params: obj } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                if (response.data == 1) {
	                    _this2.getMessage('master', "Клиент изменен", '.display-none-master');
	                    _this2.$emit('pelkchange');
	                }
	            });
	        },
	        reSaveCar: function reSaveCar() {
	            var _this3 = this;
	            ...
	            var param = $.param({ data: { c: 'CarController', m: 'updateCar', params: obj } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                if (response.data == 1) {
	                    _this3.getMessage('car', "Автомобиль изменен", '.display-none-car');
	                    _this3.$emit('pelkchange');
	                }
	            });
	        },
	        getMessage: function getMessage(alert, msg, selector) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\forms\\rentModal.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-33ffff7a/rentModal.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./rentModal.vue", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-rewriter.js!../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./rentModal.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        changeRent: function changeRent(id) {
	            var _this = this;
	            ...
	            var arrBeginDates = this.date.begin.split('.').reverse();
	            var arrBeginTimes = this.time.begin.split(':');
	            var beginUnix = new Date(arrBeginDates[0], parseInt(arrBeginDates[1] - 1), arrBeginDates[2], arrBeginTimes[0], arrBeginTimes[1]).getTime() / 1000;

	            var arrEndDates = this.date.end.split('.').reverse();
	            var arrEndTimes = this.time.end.split(':');
	            var endUnix = new Date(arrEndDates[0], parseInt(arrEndDates[1] - 1), arrEndDates[2], arrEndTimes[0], arrEndTimes[1]).getTime() / 1000;
	            var obj = {
	                id: id,
	                beginTime: beginUnix,
	                endTime: endUnix,
	            ...
	            var param = $.param({ data: { c: 'RentController', m: 'ChangeCarRent', params: obj } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                if (response.data) {
	                    console.log(response.data);
	                    _this.getMessage('rent', "Аренда изменена", '.display-none-rent');
	                    _this.getCarRents();
	                }
	            });
	        },
	        deleteRent: function deleteRent(id) {
	            ...
	            var param = $.param({ data: { c: 'RentController', m: 'deleteRent', params: obj } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                _this2.getMessage('rent', "Аренда удалена", '.display-none-rent');
	                _this2.getCarRents();
	            });
	        },
	        getCarRents: function getCarRents() {
	            var _this3 = this;

	            var obj = {
	                id: this.car.id
	            };
	            var param = $.param({ data: { c: 'RentController', m: 'getCarRents', params: obj } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                _this3.rents = _this3.formatTime(response);
	            });
	        },
	        addCarRent: function addCarRent() {
	            var _this4 = this;
	            ...
	            var param = $.param({ data: { c: 'RentController', m: 'addCarRent', params: obj } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                if (response.data) {
	                    _this4.getMessage('rent', "Аренда добавлена", '.display-none-rent');
	                    _this4.getCarRents();
	                }
	            });
	        },
	        formatTime: function formatTime(arr) {
	            if (arr.data != void 0) {
	                var formatedArr = [];
	                arr.data.forEach(function (item, index, arr) {
	        ...
	        validateInput: function validateInput() {
	            ...
	            var arrBeginDates = this.date.begin.split('.').reverse();
	            var arrBeginTimes = this.time.begin.split(':');
	            var beginUnix = new Date(arrBeginDates[0], parseInt(arrBeginDates[1] - 1), arrBeginDates[2], arrBeginTimes[0], arrBeginTimes[1]).getTime();

	            var arrEndDates = this.date.end.split('.').reverse();
	            var arrEndTimes = this.time.end.split(':');
	            var endUnix = new Date(arrEndDates[0], parseInt(arrEndDates[1] - 1), arrEndDates[2], arrEndTimes[0], arrEndTimes[1]).getTime();
	            if (!this.checkRents(beginUnix / 1000, endUnix / 1000)) {
	                return false;
	            }
	            console.log(1);
	        ...
	        checkRents: function checkRents(beginUnix, endUnix) {
	            ...
	            for (var i = 0; i < this.rents.length; i++) {
	                if (Math.min(beginUnix, endUnix) < Math.max(this.rents[i].beginUnix, this.rents[i].endUnix) && Math.min(this.rents[i].beginUnix, this.rents[i].endUnix) < Math.max(beginUnix, endUnix)) {
	                    return false;
	                }
	            }
	            return true;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) { return key !== "default" && key !== "__esModule" })) {
	  console.warn("[vue-loader] components\\manager\\rentTable.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0d0850d1/rentTable.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./rentTable.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./rentTable.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	module.exports = {
	    ...
	    methods: {
	        getRents: function getRents() {
	            ...
	            var param = $.param({ data: { c: 'RentController', m: 'getRentsForTable' } });
	            axios.post('/api', param, { headers: { 'Content-type': 'application/x-www-form-urlencoded' } }).then(function (response) {
	                console.log(response.data);
	                _this.rents = response.data;
	                _this.profitCommon = _this.getCommonProfit();
	            });
	        },
	        getCommonProfit: function getCommonProfit() {
	            var sum = 0;
	            this.rents.forEach(function (item, index, array) {
